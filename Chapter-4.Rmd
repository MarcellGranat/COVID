...
datatable(words_monthly, filter = "none", options = list(pageLength=15, scrollX='400px', dom = 't'), fillContainer = TRUE) %>% formatStyle(names(words_monthly), font="bold", fontSize = '9.5pt', background = styleEqual(as.vector(color_freq_terms$words), as.vector(color_freq_terms$colors)))
```
